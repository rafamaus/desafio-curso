<template>
    ...
    <BaseInput :value="duracaoAula" @input="updateDuracaoAula" id="duracaoAula" label="Duração da Aula" type="text" placeholder="Duração da aula em minutos" aria-disabled="false"/>
    </div>
</template>
<script>
